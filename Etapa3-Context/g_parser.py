...
def p_declaration(p):
    ...
    '''
    if (len(p)==4):
        p[0] = SyntaxLeaf('Declare', p[3], [p[1],p[3]])
    else:
        p[0] = SyntaxLeaf('Declare', p[3], [p[1],p[3],p[4],p[5]])      
